...
import com.mbv.open.api.sdk.response.express.UpdateDeliveryAddressResponse;
 ...
 *
 */
public class UpdateDeliveryAddressRequest extends BaseRequest<UpdateDeliveryAddressResponse> {
	...
	public String getApiMethod() {
		return "express/mb.logistics.deliveryaddress.update";
	}
	...
	@Override
	public Class<UpdateDeliveryAddressResponse> getResponseClass() {
		return UpdateDeliveryAddressResponse.class;
	}
