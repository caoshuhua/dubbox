...
import com.mbv.open.api.sdk.response.express.UpdateReturnAddressResponse;
 ...
 *
 */
public class UpdateReturnAddressRequest extends BaseRequest<UpdateReturnAddressResponse> {
	...
	public String getApiMethod() {
		return "express/mb.logistics.returnaddress.update";
	}
	...
	@Override
	public Class<UpdateReturnAddressResponse> getResponseClass() {
		return UpdateReturnAddressResponse.class;
	}
