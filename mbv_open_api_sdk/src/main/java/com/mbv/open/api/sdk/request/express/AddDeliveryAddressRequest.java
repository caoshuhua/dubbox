...
import com.mbv.open.api.sdk.response.express.AddDeliveryAddressResponse;
 ...
 *
 */
public class AddDeliveryAddressRequest extends BaseRequest<AddDeliveryAddressResponse> {
	...
	public String getApiMethod() {
		return "express/mb.logistics.deliveryaddress.add";
	}
	...
	@Override
	public Class<AddDeliveryAddressResponse> getResponseClass() {
		return AddDeliveryAddressResponse.class;
	}
