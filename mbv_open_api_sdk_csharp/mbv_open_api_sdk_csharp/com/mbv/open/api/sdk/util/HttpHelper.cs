...
namespace com.mbv.open.api.sdk.util
{
    ...
    public class HttpHelper
    {
        ...
        public static string BuildQuery(Dictionary<string, string> dicparam)
        {
    ...
    public class HttpConfig
    {
        ...
        public HttpConfig()
        {
            ...
            this.Accept = "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8,text/xml,text/javascript,application/json";
