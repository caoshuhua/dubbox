...
jQuery.blockUI.version = 2.38; // 2nd generation blocking at no extra cost!

// override these in your codec to change the default behavior and style
jQuery.blockUI.defaults = {
	...
	// these and use an external stylesheet then do this in your codec:
...
function install(el, opts) {
	...
	// style the overlay
	if (!opts.theme && (!opts.applyPlatformOpacityRules || !(jQuery.browser.mozilla && /Linux/.test(navigator.platform))))
